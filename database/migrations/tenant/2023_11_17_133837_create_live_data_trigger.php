...
IF (@current_alert_status!=5 OR @current_alert_status=0) AND NEW.speed > @speed_limit THEN
...
UPDATE live_data SET current_alert_status=3 WHERE deviceimei = NEW.deviceimei;
END IF;
...
END");
    ...
    {
        Schema::dropIfExists('live_data_trigger');
    }
};
