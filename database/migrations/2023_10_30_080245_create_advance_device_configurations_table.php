...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('advance_device_configurations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('vehicle_id')->nullable();
            $table->bigInteger('client_id')->nullable();
            $table->string('db_name', 60)->nullable();
            $table->bigInteger('deviceimei')->nullable();
            $table->enum('devicetype_name', ['Fuel', 'RPM', 'Temperature', 'iButton'])->nullable();
    ...
    {
        Schema::dropIfExists('advance_device_configurations');
    }
};
