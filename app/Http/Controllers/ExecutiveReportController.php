...
class ExecutiveReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            // ->select('id','vehicle_id','client_id','deviceimei','report_date','vehicle_name','start_odometer','end_odometer','distance','avg_speed','min_speed','max_speed','rpm_milege_per_hour','mileage_per_hour','start_fuel','end_fuel','fuel_fill_litre','fuel_dip_litre','fuel_consumed_litre','mileage','start_engine_hour_meter','end_engine_hour_meter',
